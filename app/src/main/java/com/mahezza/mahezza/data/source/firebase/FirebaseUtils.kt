...
fun <T> CollectionReference.addSnapshotListenerFlow(dataType: Class<T>, dispatcher: CoroutineDispatcher, notFoundOrEmptyCollectionMessage : StringResource? = null): Flow<FirebaseResult<out List<T>>> = callbackFlow<FirebaseResult<out List<T>>> {
