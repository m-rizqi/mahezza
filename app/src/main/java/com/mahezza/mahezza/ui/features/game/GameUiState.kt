...
//            lyrics = listOf(
//                Lyric("0:30", "satu-satu aku sayang ibu, dua dua juga sayang Ayah, tiga-tiga sayang Adik Kakak"),
//                Lyric("0:45", "satu dua tiga sayang semuanya [Musik] satu-satu aku sayang ibu, dua dua juga sayang Ayah"),
//                Lyric("1:00", "tiga sayang semuanya [Musik] satu-satu  aku sayang ibu dua dua juga sayang Ayah"),
//                Lyric("1:35", "aku sayang ibu dua dua juga sayang Ayah  tiga-tiga sayang Adik Kakak satu dua tiga"),
//                Lyric("1:49", "sayang semuanya [Musik] satu aku sayang  ibu dua dua juga sayang Ayah tiga-tiga"),
//                Lyric("2:05", "sayang Adik Kakak satu dua tiga sayang  semuanya satu dua tiga sayang semuanya"),
//            ),
...
//)
    ...
    val gameStepSaved : GameStepSaved? = null
) {
    enum class GameStepSaved {
        STARTED,
        PERIODICALLY,
        PLAY_SESSION,
        TWIBBON,
